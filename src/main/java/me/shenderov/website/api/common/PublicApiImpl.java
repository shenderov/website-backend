...
public class PublicApiImpl {
    ...
    public Message sendMessage(@RequestParam(name="g-recaptcha-response", required = false) String recaptchaResponse, @RequestBody Message message, HttpServletRequest request) {
